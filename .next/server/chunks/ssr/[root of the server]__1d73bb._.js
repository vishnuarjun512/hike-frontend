...
const ProfileChangerDialog = ({ isOpen, setIsOpen, setProfilePic })=>{
    ...
    const { user, setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$states$2f$user$2e$state$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"])();
    ...
    const handleUpload = async ()=>{
        ...
        try {
            ...
            const { data: { profilePicUrl } } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseUrl}/user/getUploadUrl`, {
                userId,
                filename: img.name,
                filetype: img.type
            });
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(profilePicUrl, img, {
                    headers: {
            ...
            const confirmProfilePicRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseUrl}/user/updateProfilePic`, {
                userId,
                profilePicUrl
            });
...
function SettingsPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${url}/user/${user?._id}`, {
                updatedData
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1d73bb._.js.map