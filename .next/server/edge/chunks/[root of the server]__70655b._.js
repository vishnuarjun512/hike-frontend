...
function middleware(request) {
    const token = request.cookies.get("hikeToken")?.value; // 👈 replace 'token' with your cookie name
    ...
    if (pathname === "/login" && token) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(homeUrl);
    }
    // Otherwise, continue
